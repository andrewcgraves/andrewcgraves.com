            ...
            <main className={styles.main} style={{backgroundColor: '#2A2A2E', padding: '32px'}}>
                ...
                <div style={{alignItems: 'start', paddingLeft: '32px', paddingRight: '32px'}}>
                    <div>
                        ...
                        <div className={styles.grid} style={{display: 'flex', gap: '16px'}}>
                            ...
                            <div>
                                <figure>
                                    ...
                                    <figcaption>Fig. 2: Visual guide to an invertible neural network</figcaption>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div className={styles.grid} style={{display: 'flex', gap: '16px'}}>
                            ...
                            <div>
                                <figure>
                                    ...
                                    <figcaption>Fig. 4: Training and Testing error relative to time of the mirrored model</figcaption>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div style={{marginTop: '32px', padding: '32px', backgroundColor: '#222227', borderRadius: '32px'}}>
                            <h2>Resources</h2>
                            <p>
